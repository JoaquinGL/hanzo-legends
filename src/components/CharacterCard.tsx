...
const Paragraphs: React.FC<{ paragraphs: string[]; className?: string }> = ({
  paragraphs,
  className = '',
}) => (
...
const CharacterThemedBackground: React.FC<{ character: Character }> = ({
  character,
}) => {
  ...
  switch (character.id) {
    case 'william':
      return (
        ...
        >
          ...
          <path
            d='M 640 100 Q 640 115 655 115 Q 640 115 640 130 Q 640 115 625 115 Q 640 115 640 100 Z'
            stroke={color}
            strokeWidth='1'
            fill='none'
            opacity='0.12'
          />
          <path
            d='M 520 220 Q 520 230 530 230 Q 520 230 520 240 Q 520 230 510 230 Q 520 230 520 220 Z'
            stroke={color}
            strokeWidth='0.75'
            fill='none'
            opacity='0.10'
          />
          <path
            d='M 720 380 Q 720 390 730 390 Q 720 390 720 400 Q 720 390 710 390 Q 720 390 720 380 Z'
            stroke={color}
            strokeWidth='0.75'
            fill='none'
            opacity='0.10'
    ...
    case 'gimlice':
      return (
        ...
        >
          <path
            d='M 0 580 L 150 400 L 300 580 Z'
            stroke={color}
            strokeWidth='1.5'
            fill={`${color}02`}
            opacity='0.12'
          />
          <path
            d='M 120 580 L 350 280 L 580 580 Z'
            stroke={color}
            strokeWidth='2'
            fill={`${color}01`}
            opacity='0.10'
          />
          <path
            d='M 450 580 L 650 350 L 840 580 Z'
            stroke={color}
            strokeWidth='1.5'
            fill='none'
            opacity='0.08'
          ...
          <polygon
            points='180,360 210,310 270,310 300,360 270,410 210,410'
            stroke={color}
            strokeWidth='1.5'
            fill='none'
            opacity='0.12'
          />
          <polygon
            points='190,360 215,320 265,320 290,360 265,400 215,400'
            stroke={color}
            strokeWidth='1'
            fill='none'
            opacity='0.08'
          ...
          <path
            d='M0 480 C 150 520, 300 460, 480 510 C 660 560, 750 490, 840 530'
            stroke={color}
            strokeWidth='1'
            strokeDasharray='8 4'
            opacity='0.10'
    ...
    case 'robin':
      return (
        ...
        >
          <path
            d='M -50 180 C 180 80, 420 320, 890 140'
            stroke={color}
            strokeWidth='1.5'
            opacity='0.15'
          />
          <path
            d='M -20 220 C 210 120, 450 360, 920 180'
            stroke={color}
            strokeWidth='1'
            opacity='0.10'
          />
          <path
            d='M -80 140 C 150 40, 390 280, 860 100'
            stroke={color}
            strokeWidth='1'
            strokeDasharray='4 4'
            opacity='0.12'
          ...
          <g stroke={color} strokeWidth='1' fill={`${color}03`} opacity='0.12'>
            <path
              d='M 450 100 Q 480 80 510 110 Q 470 130 450 100 Z'
              transform='rotate(15, 450, 100)'
            />
            <path
              d='M 680 240 Q 705 220 730 245 Q 695 265 680 240 Z'
              transform='rotate(-25, 680, 240)'
            />
            <path
              d='M 520 420 Q 550 400 580 430 Q 540 450 520 420 Z'
              transform='rotate(40, 520, 420)'
            />
            <path
              d='M 320 220 Q 340 205 360 225 Q 335 240 320 220 Z'
              transform='rotate(-10, 320, 220)'
            />
          </g>
        </svg>
      );
    ...
    case 'herminice':
      return (
        ...
        >
          ...
          <path
            d='M 550 140 Q 550 155 565 155 Q 550 155 550 170 Q 550 155 535 155 Q 550 155 550 140 Z'
            stroke={color}
            strokeWidth='1'
            fill='none'
            opacity='0.15'
          />
          <path
            d='M 740 220 Q 740 230 750 230 Q 740 230 740 240 Q 740 230 730 230 Q 740 230 740 220 Z'
            stroke={color}
            strokeWidth='1.5'
            fill='none'
            opacity='0.18'
          />
          <path
            d='M 620 420 Q 620 430 630 430 Q 620 430 620 440 Q 620 430 610 430 Q 620 430 620 420 Z'
            stroke={color}
            strokeWidth='1'
            fill='none'
            opacity='0.12'
      ...
      return (
        ...
        >
          <g transform='translate(180, 320)'>
            ...
            <path
              d='M 0 0 C 30 -40, 70 -40, 110 0 C 70 40, 30 40, 0 0 Z'
              stroke={color}
              strokeWidth='1'
              opacity='0.10'
              fill='none'
    ...
    case 'tigri':
      return (
        ...
        >
          ...
          <path
            d='M 280 580 Q 320 440 280 390 Q 340 430 360 580 Z'
            stroke={color}
            strokeWidth='1'
            fill={`${color}02`}
            opacity='0.15'
          />
          <path
            d='M 400 580 Q 455 360 400 320 Q 475 390 490 580 Z'
            stroke={color}
            strokeWidth='1.5'
            fill={`${color}03`}
            opacity='0.18'
          />
          <path
            d='M 520 580 Q 560 460 530 410 Q 580 440 590 580 Z'
            stroke={color}
            strokeWidth='1'
            fill={`${color}02`}
            opacity='0.15'
...
export const CharacterCard: React.FC<CharacterCardProps> = ({
  ...
  const isTransitionActive =
    isTransitioning && transitionProgress !== undefined;
  const progress = transitionProgress ?? 1;

  const [animate, setAnimate] = React.useState(false);
  const [visibleTotals, setVisibleTotals] = React.useState<
      ...
      <div
        ...
        style={{
          ...
          transition: isTransitionActive
            ? 'none'
            : 'opacity 0.2s ease-out, backdrop-filter 0.2s ease-out',
        }}
        onClick={onClose}
      />
      ...
      >
        ...
        <div
          ...
          className={`relative rounded-3xl w-[calc(100vw-32px)] max-w-[420px] md:max-w-none md:w-[900px] h-[600px] xs:h-[660px] md:h-[min(700px,calc(100vh-32px))] max-h-[calc(100vh-64px)] shadow-[0_24px_80px_rgba(15,23,42,0.12),0_2px_8px_rgba(15,23,42,0.04)] flex flex-col md:flex-row border border-slate-200/60 overflow-hidden z-10 select-none ${
            isTransitionActive || hasTransitionedRef.current
              ? ''
              : 'animate-scale-up'
          }`}
          style={{
